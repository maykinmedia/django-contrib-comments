...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_comments', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment_comments', null=True, to=orm['accounts.User'])),
        ...
        db.create_table('django_comment_flags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_flags', to=orm['accounts.User'])),
