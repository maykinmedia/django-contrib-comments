...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.object_pk'
        if db.backend_name == 'postgres':
            db.execute('ALTER TABLE "django_comments" ALTER COLUMN "object_pk" TYPE integer USING "object_pk"::integer, ALTER COLUMN "object_pk" SET NOT NULL, ALTER COLUMN "object_pk" DROP DEFAULT;')
        else:
            db.alter_column('django_comments', 'object_pk', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Comment.object_pk'
        db.alter_column('django_comments', 'object_pk', self.gf('django.db.models.fields.TextField')())

    models = {
        u'accounts.user': {
            'Meta': {'object_name': 'User'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['metadata.Category']", 'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'country': ('django_countries.fields.CountryField', [], {'default': "'NL'", 'max_length': '2'}),
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'default_role': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            'notify_local_updates': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'notify_monthly_updates': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'postal_code': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'street_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
        ...
        u'metadata.category': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['metadata.Category']"}),
